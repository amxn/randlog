...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'sub_desc' => __('Upload your logo <strong>(Recommended size 138x35px)</strong> using the Upload Button or insert image URL.', 'mythemeshop')
						),
					array(
						'id' => 'mts_favicon',
						'type' => 'upload',
...
$sections[] = array(
				...
				'fields' => array(
					array(
						'id' => 'mts_primary_color',
						'type' => 'color',
						'title' => __('Primary Color', 'nhp-opts'), 
						'sub_desc' => __('Choose the primary color for the left sidebar category background and comment submit button', 'nhp-opts'),
						'std' => '#e53b2c'
						),
					array(
						'id' => 'mts_secondary_color',
						'type' => 'color',
						'title' => __('Secondary Color', 'nhp-opts'), 
						'sub_desc' => __('Choose the secondary color for links, read-more button and borders.', 'nhp-opts'),
						'std' => '#41b7d8'
						),
					array(
						'id' => 'mts_layout',
						...
						'sub_desc' => __('Choose from <strong>4 different layouts</strong> for your site.', 'nhp-opts'),
						'options' => array(
										'scslayout' => array('img' => NHP_OPTIONS_URL.'img/layouts/ccs.png'),
										'scclayout' => array('img' => NHP_OPTIONS_URL.'img/layouts/scc.png'),
					...
					array(
						'id' => 'mts_left_sidebar_title',
						'type' => 'button_set',
						'title' => __('Left Sidebar Title', 'mythemeshop'), 
						'options' => array('0' => 'Off','1' => 'On'),
						'sub_desc' => __('Enable or disable left sidebar widget titles.', 'mythemeshop'),
						'std' => '0'
						),
					array(
						'id' => 'mts_floating_leftside',
						'type' => 'button_set',
						'options' => array('0' => 'Off','1' => 'On'),
						'title' => __('Floating Category Sidebar', 'nhp-opts'), 
						'sub_desc' => __('Choose between a floating or fixed left sidebar using this option.', 'nhp-opts'),
						'std' => '0'
						),
					array(
						'id' => 'mts_responsive',
...
$sections[] = array(
				...
				'fields' => array(
					array(
						'id' => 'mts_floating_header',
						'type' => 'button_set',
						'title' => __('Floating Header', 'nhp-opts'),
						'options' => array('0' => 'Off','1' => 'On'),
						'sub_desc' => __('Choose between a <strong>floating or fixed</strong> header navigation menu using this option.', 'nhp-opts'),
						'std' => '0'
						),
					)
				);	
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id' => 'mts_image_border',
						'type' => 'button_set',
						'title' => __('Image Border', 'nhp-opts'), 
						'options' => array('0' => 'Off','1' => 'On'),
...
if(function_exists('register_typography')) { 
  register_typography(array(
    ...
    'left_sidebar_font' => array(
      'preview_text' => 'Left Sidebar Font',
      'preview_color' => 'light',
      'font_family' => 'Bree Serif',
      'font_size' => '14px',
	  'font_variant' => '',
      'font_color' => '#333333',
      'css_selectors' => '.left-menu a, #copyright-note'
    )
  ));
}
